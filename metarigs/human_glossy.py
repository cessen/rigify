...
def create(obj):
    ...
    arm.rigify_layers[3].name = "Torso (Tweak)"
    ...
    arm.rigify_layers[17].row = 12
    arm.rigify_layers[18].name = "Leg.L (IK)"
    arm.rigify_layers[18].row = 10
    arm.rigify_layers[19].name = "Leg.L (FK)"
    arm.rigify_layers[19].row = 11
    arm.rigify_layers[20].name = "Leg.L (Tweak)"
    arm.rigify_layers[20].row = 12
    ...
    bone.head[:] = 0.0000, 0.0351, 1.0742
    bone.tail[:] = 0.0778, -0.0255, 1.1871
    bone.roll = 0.6325
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hips']]
    ...
    arm.layers = [(x in [0, 2, 3, 6, 9, 11, 13, 16, 19]) for x in range(32)]
