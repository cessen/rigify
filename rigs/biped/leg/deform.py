...
class Rig:
    ...
    def __init__(self, obj, bone, params):
        ...
        # Get rig parameters
        use_thigh_twist = params.use_thigh_twist
        use_shin_twist = params.use_shin_twist
        
        # Based on common limb
        self.rubber_hose_limb = limb_common.RubberHoseLimb(obj, self.org_bones[0], self.org_bones[1], self.org_bones[2], use_thigh_twist, use_shin_twist)
