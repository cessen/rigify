...
class Rig:
    ...
    def create_ctrl( self, bones ):
        ...
        self.create_eye_widget( self.obj, eyeL_ctrl_name )
        self.create_eye_widget( self.obj, eyeR_ctrl_name )
        ...
        earL_ctrl_name = copy_bone( self.obj, bone['ears'][0], earL_name )
        earR_ctrl_name = copy_bone( self.obj, bone['ears'][1], earR_name )
        ...
        eb[ jaw_ctrl_name ].head[:] = ( jawL_org_e + jawR_org_e ) / 2
